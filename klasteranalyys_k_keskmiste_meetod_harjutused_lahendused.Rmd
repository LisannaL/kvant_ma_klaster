...
Proovimegi nüüd arvutada klastrid, võttes arvesse indiviididevahelisi kauguseid kõigi kuue rahulolu tunnuse lõikes. Kontrollime ka eelnevalt, kas tunnuste alusel võiks leiduda loomulikke klastreid.
...
Jooniselt näeme, et need klastrid, kus keskmine rahulolu oli enamikus dimensioonides kõrgem, on ka haridustee keskmiselt pikem, ühes neist klastritest on ka naiste osakaal mõnevõrra kõrgem. Need infokillud võivad aidata meil mõtestada sisulisemalt, mis on klastritevahelised erinevused ja mis võib erisuguste indiviidide eri klastritesse paigutumise taga olla. Kui analüüsiksime samamoodi nt oma ettevõtte kliendibaasi, aitaks see meil oma klientuuri, selle struktuuri ja eripärasid paremini mõista.
